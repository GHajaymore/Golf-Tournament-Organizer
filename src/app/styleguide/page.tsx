...
const MATCHES = [
  { a: "Ann Doyle", b: "Rob Ferris", flight: "Flight 1", on: true, tag: "2 up", tagClass: "tag-accent" },
...
const SAMPLE = [
  { pos: 1, name: "Ann Doyle", hcp: 8, thru: "F", gross: 74, net: 66, tag: "Advancing" },
